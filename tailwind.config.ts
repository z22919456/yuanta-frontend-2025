  ...
  theme: {
  	...
  	extend: {
  		...
  		backgroundImage: {
  			...
  			'gradient-triangle': 'linear-gradient(135deg, #910612 50%, transparent 50%)',
  	...
  	keyframes: {
  		...
  		pulse: {
  			'0%, 100%': {
  				backgroundColor: '#D84029'
  			},
  			'50%': {
  				backgroundColor: '#910612'
  			}
  		},
  		spin: {
  			'0%': {
  	...
  	animation: {
  		...
  		'bounce-in': 'bounceIn 1.5s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards',
